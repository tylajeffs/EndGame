...
public class GameView extends AppCompatImageView implements TimerListener, ScoreTimerListener
{
    ...
    public void onDraw(Canvas c)
    {
        ...
        c.drawText("Score: " + totalScore,w - 10,50,scorePaint);
    ...
    public void instantiateGameType()
    {
        ...
        {
            //counting game
            gameStyle = new CountingGame(maxLevels);
        }
        else if(gameType == 2)
        {
            //flower game
        ...
        {
            //alphabet game
            gameStyle = new AlphabetGame(maxLevels);
        }
        else if(gameType == 4)
        {
            //hawaii game
                ...
                if(square.contains(x,y))
                {
                    ...
                    switch (gameStyle.getGameStatus(square))
                    {
                        ...
                        case GAME_OVER:
                            ...
                            {
                                //write over the file to store current score as high score
                                //TODO WRITE THE HIGH SCORE
                                ...
                                ab.setTitle("NEW HIGH SCORE!");
                                ab.setMessage("You got a new high score of " + totalScore + "! Would you like to play again?");
                            ...
                            else
                            {
                                ...
                                ab.setMessage("You made it to the last level! Would you like to play again? The current highscore is " + highScore);
                            }
                            ...
                            ab.setNegativeButton("No", (d,i) -> ((Activity)getContext()).finish());
